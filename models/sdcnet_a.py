...
class CDCM(nn.Module):
    """
    SDCNet uses a slightly different version of CDCM, so we define it here separately
    """
...
def sdcneta(args):
    ...
    return SDCNetA(diffconvs, bn=args.bn, kernel_size=kernel_size)
